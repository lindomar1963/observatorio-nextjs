    ...
    <main>
      ...
      <section style={{background:'linear-gradient(135deg,#0A1628,#0F2A45)',minHeight:'82vh',display:'flex',alignItems:'center',justifyContent:'center',padding:'4rem 2rem'}}>
        <div style={{textAlign:'center',maxWidth:560}}>
          ...
          <h1 style={{fontFamily:'Georgia,serif',fontSize:30,fontWeight:700,color:'#fff',lineHeight:1.25,marginBottom:'1rem'}}>Notícias e Eventos</h1>
          <p style={{color:'rgba(255,255,255,0.55)',fontSize:14,lineHeight:1.7,marginBottom:'2rem'}}>Acompanhe as últimas notícias, eventos e publicações do Observatório. Esta seção está em desenvolvimento e estará disponível em breve.</p>
