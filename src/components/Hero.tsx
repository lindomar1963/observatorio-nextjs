      ...
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <div className="flex flex-wrap gap-3">
            <Link
              href="/paineis"
              className="bg-obs-gold text-obs-navy font-bold px-6 py-3 text-sm tracking-wider hover:bg-yellow-500 transition-colors"
            >
              Acessar Painéis
            </Link>
            <Link
              href="/relatorios"
              className="border border-white/30 text-white font-semibold px-6 py-3 text-sm tracking-wider hover:border-white/60 transition-colors"
            >
              Últimos Relatórios
            </Link>
          </div>
        ...
        <div className="grid grid-cols-2 gap-3" aria-label="Indicadores institucionais">
          {[
            { num: '62', label: 'Municípios monitorados', sub: '100% do estado', color: '#C9963B' },
            { num: '48', label: 'Relatórios publicados', sub: '+12 em 2026', color: '#1A6B3C' },
